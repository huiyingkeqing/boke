...
if __name__ == '__main__':
    model = YOLO('mystyle-model/v11-CSP-ASFP2.yaml')
    # model.load('yolo11n.pt') # loading pretrain weights
    # model.train(data=r'D:/Dashuai/Dataset/data-bdd100k/data.yaml',
    model.train(data=r'D:/Dashuai/Dataset/data_nuscenes/data.yaml',
                cache=False,
                imgsz=640,
                epochs=300,
                batch=8,
